...
override CFLAGS += -mthumb -mthumb-interwork -Og -mabi=apcs-gnu -mtune=arm7tdmi -march=armv4t -fno-toplevel-reorder -Wno-pointer-to-int-cast -std=gnu17 -fanalyzer -ggdb
ROM := $(MODERN_ROM_NAME)
